...
import com.example.snsproject.databinding.ActivityStorageBinding
...
class StorageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imageRef1 = storageRef.child("sangsangbugi.jpg")
        val imageRef2 = storage.getReferenceFromUrl(
            "gs://sns-project-2022.appspot.com/sangsangbugi.jpg"
        )
    ...
    private fun uploadFile(file_id: Long, fileName: String) {
        val imageRef = storage.reference.child("${UPLOAD_FOLDER}${fileName}") // StorageReference
